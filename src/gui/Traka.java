...
/**
 * Panel na vrhu prozora koji prikazuje bodove i status o završetku igre
 * 
...
public class Traka extends JPanel {
	...
	/**
	 * Dodaj nove bodove u tekstualno polje
	 * 
	 * @param b broj bodova za dodati
	 */
	public void dodajBodove(int b) {
		int dodati = Integer.parseInt(bodovi.getText()) + b;
		bodovi.setText(String.valueOf(dodati));
	}

	/**
	 * Mijenja status tekst na proslijeđeni string
	 * 
	 * @param txt tekst koji želimo postaviti
	 */
	...
	/**
	 * Konstruktor koji poziva funkciju za postavljanje panela
	 */
	public Traka() {
		build();
	}
